...
SECRET_KEY = 'django-insecure-e2g(o^xa+t3qe4lgi4ditiyc+uq(z)67brz#w3s2!61!fx$z+3'
...
MIDDLEWARE = [
    ...
    'users.middleware.CheckUserPermissionsMiddleware',
...
CACHE_ENABLED = os.getenv('CACHE_LOCATION', 'False') == "True"
